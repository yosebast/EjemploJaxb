 ...
 * generated in the org.prueba.crearxsd3.clases package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAccountResponse_QNAME = new QName("http://creaxsd3.prueba.org/", "getAccountResponse");
    private final static QName _Account_QNAME = new QName("http://creaxsd3.prueba.org/", "account");
    private final static QName _GetAccount_QNAME = new QName("http://creaxsd3.prueba.org/", "getAccount");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.prueba.crearxsd3.clases
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://creaxsd3.prueba.org/", name = "getAccountResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://creaxsd3.prueba.org/", name = "account")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://creaxsd3.prueba.org/", name = "getAccount")
